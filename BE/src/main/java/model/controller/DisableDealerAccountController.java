 ...
 * @author Admin
 */
@WebServlet("/api/EVM/disableDealerAccount")
public class DisableDealerAccountController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean success = userAccountService.disableDealerAccount(userId);
            ...
            if (success) {
                ...
                ResponseUtils.success(response, "Dealer account disabled successfully", data);
            } else {
                response.setStatus(HttpServletResponse.SC_NOT_FOUND);
                ResponseUtils.error(response, "Failed to disable dealer account or user not found");
            }
